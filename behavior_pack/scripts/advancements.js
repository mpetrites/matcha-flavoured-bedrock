...
const itemUseOnEvent=world.afterEvents.itemUseOn;
if (itemUseOnEvent) itemUseOnEvent.subscribe(({source,itemStack})=>emit(source,"item_used_on_block",{item:itemStack.typeId}));
