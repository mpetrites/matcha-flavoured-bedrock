...
bp_name="Matcha_Flavoured_Alpha_BP_0.11.6.mcpack"
rp_name="Matcha_Flavoured_Alpha_RP_0.11.6.mcpack"
addon_name="Matcha_Flavoured_Bedrock_Alpha_0.11.6.mcaddon"
